<?php
/*
Template Name: Layout Category Academy
*/
...
<?php if ( ! $is_page_builder_used ) : ?>
	<div class="container-gca">
		<?php 
			...
			$_getSlugTerm = wp_get_post_terms( $post->ID, 'project_category' );
			// echo '<pre>';
			// echo $_getSlugTerm[3]->name;
			// echo '</pre>';
									...
									<div class="item-hero-gca et_pb_row">
										...
										<div class="et_pb_module et_pb_text et_pb_text_1 et_pb_bg_layout_dark  et_pb_text_align_left">
											<div class="et_pb_text_inner et_pb_text_1">
												<h1>Incredible breast surgery training for aesthetic surgeons.</h1>
											</div>
										</div>
		...
		<div class="row filtro-search align-items-center">
			<div class="col-sm-2">
				<div class="row align-items-center">
					<div class="col-3">
					<button type="button" class="btn btn-sm btn-filter-academy" data-toggle="button" aria-pressed="false" autocomplete="off">
