...
<?php $showHideComment = (have_comments()) ? "" : "showComment"; ?>
<section id="comment-wrap" class=<?php echo $showHideComment; ?>>
<?php if ( have_comments() && ! empty( $comments_by_type['comment'] ) ) : ?>
	
	<h4 id="comments" class="page_title js-showHideComment"><?php comments_number( esc_html__( '0 ', 'Divi' ), esc_html__( '1 ', 'Divi' ) ); ?></h4>
<?php endif; ?>
